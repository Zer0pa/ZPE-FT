...
<div><b>02 · MARKETS</b> <span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Market data '30</span>  <span>$52.1B</span></div>
          <div><span>Fintech analytics '30</span>  <span>$45.6B</span></div>
          <div><span>Capital markets software '30</span>  <span>$31.4B</span></div>
          <div><span>Time-series database '30</span>  <span>$5.7B</span></div>
          <div><span>Financial data infrastructure '31</span>  <span>$78.9B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b> <span>DELAYED-FEED PUBLIC CORPORA</span></div>
      <div>
        ...
        <div>
          <div><span>SPY</span>  <span>5.94&times;</span></div>
          <div><span>BTC</span>  <span>10.90&times;</span></div>
          <div><span>Kaggle</span>  <span>7.31&times;</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE · DELAYED-FEED VS RAW</b></div>
      <div>
        <div>
          <div><span>SPY 10y</span>  <span><strong>5.94&times; smaller</strong></span></div>
          <div><span>BTC aggTrades</span>  <span><strong>10.90&times;</strong></span></div>
          <div><span>Kaggle SPY</span>  <span><strong>7.31&times;</strong></span></div>
          <div><span>Phase 06</span>  <span><em>pending</em></span></div>
        </div>
      </div>
