"""Finance telemetry bundle mirroring the orchestrator adapter pattern."""
...
from .comet_logging import DEFAULT_PROJECT, DEFAULT_WORKSPACE


DEFAULT_CLASSIC_PROJECT = DEFAULT_PROJECT
DEFAULT_OPIK_PROJECT = DEFAULT_PROJECT
DEFAULT_OPIK_URL = "https://www.comet.com/opik/api"
DEFAULT_THREAD_ID = "zpe-ft-phase06"
