...
| Historical absolute paths | Some preserved reruns and logs still carry workstation-specific paths. | Historical evidence is lineage, not current repo-native instruction. |
